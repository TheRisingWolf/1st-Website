		...
		<main class="main">
			<div class="content">
				<nav>
					...
					<img src="content/image2.jpeg" alt="" width="100%">
					...
					//$query = mysqli_query($connect, "SELECT * FROM art WHERE `art`.`pagename` = 'articles'");
					$query = mysqli_query($connect, "SELECT * FROM content WHERE `content`.`pagename` = 'HISTORY'");
